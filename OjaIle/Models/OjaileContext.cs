...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=OBAFEMI;Database=Ojaile;Trusted_Connection=True;MultipleActiveResultSets=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PropertyItem>(entity =>
            {
                ...
                entity.HasOne(d => d.Country)
                    ...
                    .HasConstraintName("FK_PropertyItem_Countries");

                entity.HasOne(d => d.CreatedByNavigation)
                    .WithMany(p => p.PropertyItemCreatedByNavigations)
                ...
                entity.HasOne(d => d.PropertyType)
                    ...
                    .HasConstraintName("FK_PropertyItem_PropertyType1");
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.PropertyItemUsers)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK_PropertyItem_AspNetUsers1");
            });
            ...
            modelBuilder.Entity<PropertyUnit>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedByNavigation)
                    .WithMany(p => p.PropertyUnitCreatedByNavigations)
                    .HasForeignKey(d => d.CreatedBy)
                    .HasConstraintName("FK_PropertyUnit_AspNetUsers");
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.PropertyUnitUsers)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK_PropertyUnit_AspNetUsers1");
            });
            ...
            modelBuilder.Entity<ServicePropertyUnit>(entity =>
            {
                ...
                entity.HasOne(d => d.CreatedByNavigation)
                    ...
                    .HasForeignKey(d => d.CreatedBy)
                    .HasConstraintName("FK_ServicePropertyUnit_AspNetUsers");
